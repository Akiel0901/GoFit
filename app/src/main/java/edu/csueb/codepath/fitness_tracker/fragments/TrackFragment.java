...
public class TrackFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        workouts.add("Push Up: Chest");
        workouts.add("Inclined Push Up: Chest");
        workouts.add("Sit-Up: Core");
        workouts.add("Leg Raise: Core");
        workouts.add("Russian Twist: Core");
        workouts.add("Jogging: Endurance");
        workouts.add("Jumping Rope: Endurance");
        workouts.add("Burpees: Endurance");
        workouts.add("Squats: Legs");
        workouts.add("Lunges: Legs");
        workouts.add("Pull-Up: Back");
        workouts.add("Dumbbell Rows: Back");
        workouts.add("Dumbbell Flys: Back");
